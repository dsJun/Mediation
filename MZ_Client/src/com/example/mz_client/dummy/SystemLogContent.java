...
public class SystemLogContent {
     ...
     */
    public static ArrayList<SystemLog> ITEMS = new ArrayList<SystemLog>();

    /**
     * A map of sample (dummy) items, by ID.
     */
    public static Map<String, SystemLog> ITEM_MAP = new HashMap<String, SystemLog>();
...
//    }
    ...
    public static void addItem(SystemLog item) {
        ITEMS.add(item);
